...
public class MapPractise {
    ...
    public static void main(String[] args) {
        ...
        for (String sList : data) {
            movieInfos.add(sList);
        }

        for (String movieNameAndYear : movieInfos) {
            String stringArray = Arrays.toString(movieNameAndYear.split("-"));
        }
       // Integer stringIntoInt= Integer.valueOf(Arrays);
       // System.out.println(stringIntoInt);
