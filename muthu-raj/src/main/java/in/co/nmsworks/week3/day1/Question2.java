 ...
 * one being List<String> list1 = Arrays.asList("Red", "Green", "Blue") and
 * another being List<String> list2 = Arrays.asList("Yellow", "Black", "White"),
 * such that the resulting list contains all elements from both lists
