...
public class SearchBook{
    ...
    public SearchBook() {
        ...
        for (Book book : listOfBooks) {
            ...
            nameToBook.put(book.getBookName(), book);
            authorToBook.put(book.getAuthor(), book);
    ...
    public static void main(String[] args) {
        ...
        Book book = new Book(2308202405l," Pride and Prejudice"," Jane Austen","Fiction",1813);
    ...
    private static void printBookDetails(Book book) {
        ...
        System.out.println("Year of Release :\t" + book.getReleaseYear());
        System.out.println("\n");
    }
